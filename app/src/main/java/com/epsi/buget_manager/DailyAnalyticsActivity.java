...
//imageviews
    ...
    private void getTotalWeekPersonalExpenses(){
        ...
        Calendar cal = Calendar.getInstance();
        String date = dateFormat.format(cal.getTime());
        String itemNday = "Personnel"+date;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    totalBudgetAmountTextView.setText("Dépenses Totales journalières: € "+ totalAmount);
                    monthSpentAmount.setText("Dépenses Totale: € "+totalAmount);
                }
                else {
                    totalBudgetAmountTextView.setText("Vous n'avez aucune dépense aujourd'hui");
