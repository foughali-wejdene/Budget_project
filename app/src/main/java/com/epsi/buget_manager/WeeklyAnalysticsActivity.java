...
public class WeeklyAnalysticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weekly_analystics);
...
//imageviews
    ...
    private void getTotalWeekTransportExpense() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(WeeklyAnalysticsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void getTotalWeekFoodExpense(){
        ...
        String itemNweek = "Courses"+weeks.getWeeks();
    ...
    private void getTotalWeekHouseExpenses(){
        ...
        String itemNweek = "Maison"+weeks.getWeeks();
    ...
    private void getTotalWeekEntertainmentExpenses(){
        ...
        String itemNweek = "Sport"+weeks.getWeeks();
    ...
    private void getTotalWeekHealthExpenses(){
        ...
        String itemNweek = "Santé"+weeks.getWeeks();
    ...
    private void getTotalWeekPersonalExpenses(){
        ...
        String itemNweek = "Personnel"+weeks.getWeeks();
    ...
    private void getTotalWeekOtherExpenses(){
        ...
        String itemNweek = "Autres"+weeks.getWeeks();
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    Toast.makeText(WeeklyAnalysticsActivity.this,"Child does not exist", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() ){
                    ...
                    Toast.makeText(WeeklyAnalysticsActivity.this, "setStatusAndImageResource Errors", Toast.LENGTH_SHORT).show();
                }
            }
