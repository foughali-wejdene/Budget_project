...
public class MonthlyAnalysticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monthly_analystics);
...
//imageviews
    ...
    private void getTotalWeekTransportExpense() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MonthlyAnalysticsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void getTotalMonthsFoodExpense(){
        ...
        String itemNmonth = "Courses"+months.getMonths();
    ...
    private void getTotalMonthEntertainmentExpenses(){
        ...
        String itemNmonth = "Sport"+months.getMonths();
    ...
    private void getTotalWeekHealthExpenses(){
        ...
        String itemNmonth = "Santé"+months.getMonths();
    ...
    private void getTotalWeekPersonalExpenses(){
        ...
        String itemNmonth = "Personnel"+months.getMonths();
    ...
    private void getTotalWeekOtherExpenses(){
        ...
        String itemNmonth = "Autres"+months.getMonths();
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    totalBudgetAmountTextView.setText("Total du mois: € "+ totalAmount);
                    monthSpentAmount.setText("Dépenses Totales: € "+totalAmount);
                }else {
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    data.add(new ValueDataEntry("Maison", houseTotal));
                    data.add(new ValueDataEntry("Courses", foodTotal));
                    data.add(new ValueDataEntry("Sport", entTotal));
                    ...
                    data.add(new ValueDataEntry("Santé", heaTotal));
                    data.add(new ValueDataEntry("Personnel", perTotal));
                    data.add(new ValueDataEntry("Autres", othTotal));


                    pie.data(data);

                    pie.title("Analyse dépense du mois");
                    ...
                    Toast.makeText(MonthlyAnalysticsActivity.this,"Child does not exist", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    Toast.makeText(MonthlyAnalysticsActivity.this, "setStatusAndImageResource Errors", Toast.LENGTH_SHORT).show();
                }
            }
